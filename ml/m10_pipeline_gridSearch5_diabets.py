...
# model.score :  0.42773384995833286
# 정답률 :  0.42773384995833286
# 걸린시간 :  4.726002931594849


# 최적의 매개변수 :  Pipeline(steps=[('scaler', MinMaxScaler()),
#                 ('rg', RandomForestRegressor(max_depth=3, min_samples_leaf=5))])    
# best_score :  0.4430982862020305
# best_params :  {'rg__min_samples_leaf': 5, 'rg__max_depth': 3}
# model.score :  0.4458490030144746
# 정답률 :  0.4458490030144746
# 걸린시간 :  4.677647590637207