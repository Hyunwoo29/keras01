...
# ic(x_train.shape[0])  # ic| x_train.shape[0]: 60000
augment_size = 40000
...
model = Sequential()
model.add(Conv2D(162, (2,2), input_shape=(28, 28, 1)))
...
hist = model.fit(x_train, y_train, epochs=1000, steps_per_epoch=32, # 160 / 5 = 32
...
#훈련데이터 10만개
# ic| loss[0]: 0.31742528080940247
# ic| loss[1]: 0.9649999737739563