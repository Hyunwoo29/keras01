...
model.add(LSTM(64, return_sequences=True))   # 3차원 -> 3차원
model.add(Conv1D(64, 2))  # 3차원
...
# ic| y_predict: array([[ 98.43553 ],
#                       [ 99.320694],
#                       [100.1084  ],
#                       [100.937   ]], dtype=float32)
# 걸린시간 : 13.973322868347168
# loss : 0.03068201243877411
# R2 스코어 :  -5.299705835571513
# ic| rmse: 2.806177523690258