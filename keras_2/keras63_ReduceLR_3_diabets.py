...
start = time.time()
model.fit(x_train, y_train, epochs=100, verbose=1, validation_split=0.2, batch_size=8, shuffle=True, callbacks=[es, reduce_lr])
...
# adam = 0.001
# ic| r2: 0.37969867665679213
# ic| f'{걸린시간}분': '0.7분'

# Nadam
# ic| r2: 0.41131645887393564
# ic| f'{걸린시간}분': '1.0분'