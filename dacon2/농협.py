...
cus = pd.read_csv("./_data/cus_info.csv")
iem = pd.read_csv("./_data/iem_info_20210902.csv")
hist = pd.read_csv("./_data/stk_bnc_hist.csv")
train = pd.read_csv("./_data/stk_hld_train.csv")
test = pd.read_csv("./_data/stk_hld_test.csv")

submission = pd.read_csv("./_data/sample_submission3.csv")
...
submission.to_csv("dacon_nonghub01.csv", index = False)