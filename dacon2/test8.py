...
save_path = f'./_save/best_model1.pt' # 모델 저장 경로
...
submission = pd.read_csv('./_data/sample_submission1.csv')
...
submission.to_csv('./_data/dacon_baseline125.csv', index=False)
...
#     'dacon_baseline.csv', 
#     '08b0658431b11c53ea0570b27934cd3ba969346b2fb596bab31ac2bbefd572e6', 
#     '235801', 
#     'DACONIO', 
#     'DACON_Baseline'
# )